...
The 5th argument mixes in stream_type=3 IMU datagrams (300 == the real 100 Hz
...
def blaster(port, words, target_pps, seconds, counter, lfp_every=0, lfp_words=142,
    ...
    struct.pack_into('<I', ipkt, 4, 0x00000103)    # stream_type = 3 (IMU), port A
        ...
        while time.perf_counter() < end:
            for _ in range(512):
                ...
                if imu_every and seq % imu_every == 0:
                    ...
                    pack_into('<I', ipkt, 4, 0x00000103 | (port << 16))
