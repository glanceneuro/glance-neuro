...
`stream_type`: **1 = BROADBAND, 2 = LFP, 4 = IMU.** (Type 3 is reserved for a possible
future wavelet/scalogram stream — sketched at the end; not implemented.)
...
### IMU (type 4) — BNO055 side channel
